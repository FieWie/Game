...
class test2(Action):
    ...
    def spawn_obj(self):
        self.obj = gameObject(self.x,self.y,"objtest", "🟥",places["house"], False)
        time.sleep(3)
        self.remove_obj()
    
    def remove_obj(self):
        self.obj.deleteObject()
...
spike_handler1 = SpikeHandler("spike", "🟥", 12, places["house"], True, 1)
spike_action1 = Action(spike_handler1.Print_spike)

ye = [[1, 10], [2, 18]]
lazer1 = Lazer("obj", "🧧", ye, places["house"], 0, -1, 2, True, 1)
lazer_action1 = Action(lazer1.move_objects)

ye = [[7, 10], [8, 18]]
lazer2 = Lazer("obj", "🧧", ye, places["house"], 0, -1, 2, True, 1)
lazer_action2 = Action(lazer2.move_objects)

spike_handler2 = SpikeHandler("spike", "🟥", 12, places["house"], True, 1)
spike_action2 = Action(spike_handler2.Print_spike)

ye = [[3, 10], [4, 18]]
lazer3 = Lazer("obj", "🧧", ye, places["house"], 0, -1, 2, True, 1)
lazer_action3 = Action(lazer3.move_objects)

ye = [[5, 10], [6, 18]]
lazer4 = Lazer("obj", "🧧", ye, places["house"], 0, -1, 2, True, 1)
lazer_action4 = Action(lazer4.move_objects)


sequence1 = Sequence("sequence1", [
    SequenceStep([spike_action1]),
    SequenceStep([lazer_action1, lazer_action2]),
    SequenceStep([spike_action2]),
    SequenceStep([lazer_action3,lazer_action4]),
])
